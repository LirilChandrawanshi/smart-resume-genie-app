          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <p className="mb-4">
                ...
                eye-catching resumes without the hassle. Founded in 2025 by Aayushi Solanki, 
              ...
              <p>
                ...
                Aayushi understood the importance of a well-crafted resume in making a strong first impression. 
            ...
            <CardContent className="p-6">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="w-full md:w-2/3">
                  <h3 className="text-xl font-medium mb-2">Aayushi Solanki</h3>
                  <p className="text-muted-foreground mb-2">Founder & Lead Developer</p>
                  <Separator className="my-3" />
                  <p className="mb-3">
                    Aayushi is a passionate full-stack developer with expertise in React, Spring Boot, and AI technologies. 
                  ...
                  <p>
                    When not coding, Aayushi enjoys hiking, reading science fiction, and contributing to open-source projects. 
